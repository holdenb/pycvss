...
SAMPLE_VIDEO_RUNNING_DOG_HD = os.path.join(SAMPLE_VIDEO_DIR, 'running_dog_hd.mp4')
SAMPLE_VIDEO_BRIDGE = os.path.join(SAMPLE_VIDEO_DIR, 'paris_people_bridge00_preview.mp4')
